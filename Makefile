...
# linker flags:
LFLAGS = ./Resources/resource.res /LIBPATH:./Includes/Libraries assimp-vc142-mt.lib zlib.lib cuda.lib cudart.lib glfw3dll.lib glm_static.lib yaml-cpp.lib python39.lib python3.lib rttr_core.lib rttr_core_lib_s.lib rttr_core_s.lib librttr_core_s.lib ComDlg32.lib Test.lib FirstClass.lib VectorOperations.lib Postprocess.lib
